        ...
        resolveWebviewView(webviewView) {
            ...
            webviewView.webview.onDidReceiveMessage(async (message) => {
                ...
                if (message.type === 'fix-request') {
                    ...
                    // --- Prompt construction ---
                    const prompt = `Fix and improve the following ${language} code. Return only the fixed version of these lines, and nothing else. Do not repeat the rest of the code.\n${code}${diagnosticsText}`;
